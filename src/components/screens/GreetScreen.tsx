...
const QUOTES = [
  ...
  "You don't need a new day to start over — any moment will do.",
  ...
  "Your habits are shaping you into who you'll be.",
  "The body achieves what the mind believes.",
  "Resilience is knowing that you are the only one who will pick you up.",
  ...
  "Hard days build the strength for easy ones.",
  "Your potential is limitless — keep going.",
  "The secret is: just keep showing up.",
  "Kindness toward yourself is not weakness — it's wisdom.",
  "Start where you are. Use what you have. Do what you can.",
  "Energy flows where attention goes.",
  "Slow progress is still progress.",
  "Not every day will be great, but there's something great in every day.",
  "You are becoming a better version of yourself with every choice.",
  ...
  "Nourish your mind. Nourish your body. Nourish your soul.",
  "The mountain is conquered one step at a time.",
  "Every day is a second chance.",
  "What got you here won't get you there — grow.",
  "You are more capable than you feel on hard days.",
  "Courage is taking the first step even when you can't see the whole staircase.",
  "Your health is your wealth.",
  "Push yourself — because no one else is going to do it for you.",
  "Embrace the process. The outcome will follow.",
  "A year from now you'll wish you had started today.",
  "You are worth the time you invest in yourself.",
  "Strive for progress, not perfection.",
  "Build the life you want, one habit at a time.",
  "Even on your worst day, you are enough.",
  "Peace is the result of training your mind to process life as it is.",
  "Take the first step in faith. You don't have to see the whole staircase.",
  "The most common form of despair is not being who you are — be you.",
